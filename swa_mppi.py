#!/usr/bin/env python3
"""
SWA-MPPI v3: Dynamic Social Consensus for Cross-Cultural Value Negotiation
via Implicit Pre-Logit Control.
Runs SWA-MPPI experiment across 15 countries.
"""
...
def main():
    ...
    amce_df_out.to_csv(os.path.join(config.output_dir, "swa_amce_summary.csv"), index=False)
